    ...
    <nav>
        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <div class="flex justify-center pt-10 bg-red-600">
                    <h1 class="red pb-4">Create A new Computer </h1>
                </div>

                <div class="flex justify-center mt-8">
                    
                    <form action="{{route('computers.store')}}" method="post" class="mt-6">
                        @csrf
                        <div>
                            <label for="computer-model">Computer Name</label>
                            <input type="text" id="computer-model" name="computer-model" value="{{old('computer-model')}}" >
